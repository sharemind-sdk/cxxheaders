...
#ifdef SHAREMIND_MAYBEDYNAMICPACKEDSTRUCT_TEST
...
int main() {
    MaybeDynamicPackedStruct<int64_t, char, R, char, A<int32_t>, uint16_t> m(3u, 10u);
    ...
    auto const r2 = m.ref<3u>();
    auto const cr2 = m.cref<3u>();
    m.set<3u>('Y');
    auto const r4 = m.ref<4u>();
    auto const cr4 = m.cref<4u>();
...
#endif /* SHAREMIND_MAYBEDYNAMICPACKEDSTRUCT_TEST */
